...
13. Latent variables & CFA `r fontawesome::fa(name = "r-project", height = "1em")`
...
## When & where (to be updated!)

\fontsize{9pt}{12}\selectfont \color{red}
Note: These are the current dates and places for the exam, but they will probably change as I asked moving to a room with computers (the exam will be done on Moodle) \newline &rightarrow; **Check the \color{blue} [annoucements on Moodle](https://psico.elearning.unipd.it/mod/forum/view.php?id=192277) \color{red} for keeping updated** \color{black}
...
__Exam contents__: The contents required by the exam are exhaustively \newline covered in \color{red}the [main course slides](#slides)\color{black}. Note that the required contents will \color{red} depend on where we arrive \color{black at the end of the course \newline \color{black}
